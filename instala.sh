...
funcao_idioma () {
 echo -e " "
msg -bar2
cowsay -f eyes "BIENVENIDO Y GRACIAS POR UTILIZAR NEW-ADM OFICIAL BY SYC ANDROID" | lolcat
figlet ADMSYC | lolcat
 echo -e " "
msg -bar2
...
echo -e " Syc / menu / adm" && msg -verm "$(source trans -b pt:${id} "Reinicie su servidor para completar la instalación"|sed -e 's/[^a-z -]//ig')"
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/sys-on/GENSYC/main/Install/trans &> /dev/null
msg -bar2
msg -ama "[ NEW - ULTIMATE - SCRIPT ] ➣ \033[1;33m[\033[1;34m OFICIAL BY-SYC ANDROID \033[1;33m]"
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   ...
   echo "${SCPdir}/menu" > /usr/bin/syc && chmod +x /usr/bin/syc
   inst_components
